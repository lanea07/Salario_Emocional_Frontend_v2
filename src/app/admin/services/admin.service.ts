...
export class AdminService {
  ...
  getAllBenefitUser ( data: any ): Observable<ApiV1Response<BenefitUserElement[]>> {
    let params = this.cleanParams( data );
    return this.http.get<ApiV1Response<BenefitUserElement[]>>( `/admin/getAllBenefitUser`, { params, withCredentials: true } )
  }
